                ...
                <div className="flex items-center justify-between h-20  ">
                    ...
                    <div className="hidden md:flex items-center space-x-8  flex-wrap overflow-hidden">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <a href="#"  className="hover:text-white transition-colors" aria-label="Curriculum Vitae">
                            ...
                            <a href="#"  aria-label="Curriculum Vitae">
                                <span className='font-bold font-custom hover:text-primary'>EN/ES</span>
                            </a>
                        </div>
                    </div>
